...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_footer_menu_js__WEBPACK_IMPORTED_MODULE_4__["getOpenMenu"])(); // Modules
  // ---------------------------------
...
var getOpenMenu = function getOpenMenu() {
  buttonNav.addEventListener('click', function () {
    ...
    var styleNav = footerNav.style.display = 'block';
  ...
  buttonCont.addEventListener('click', function () {
    contactNav.style.display = 'block';
    var styleContact = contactNav.style.display = 'block';
